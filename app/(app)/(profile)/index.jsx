                    ...
                    <View style={styles.profileSection}>
                        ...
                        <View style={styles.profileInfo}>
                            ...
                            {(user?.noShowCount ?? 0) > 0 && (
                                <View style={[
                                    styles.noShowBadge,
                                    (user?.noShowCount ?? 0) >= 3 && styles.noShowBadgeCritical
                                ]}>
                                    <MaterialIcons
                                        name="warning"
                                        size={14}
                                        color={(user?.noShowCount ?? 0) >= 3 ? '#fff' : '#92400e'}
                                    />
                                    <Text style={[
                                        styles.noShowBadgeText,
                                        (user?.noShowCount ?? 0) >= 3 && styles.noShowBadgeTextCritical
                                    ]}>
                                        {(user?.noShowCount ?? 0) >= 3
                                            ? `⚠️ ${user.noShowCount} No-Shows — Prepayment Required`
